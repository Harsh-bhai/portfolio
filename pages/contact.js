...
/>
      ...
      >
          ...
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                ...
                className="flex mx-auto text-white bg-cyan-500 border-0 py-2 px-8 focus:outline-none hover:bg-cyan-600 rounded text-lg rounded-full"
              >
                Button
              </button>
            </div>
        ...
        <span className="flex  space-x-4 sm:mx-auto sm:mt-0 mt-2 justify-center sm:justify-start">
