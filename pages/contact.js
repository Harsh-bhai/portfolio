...
/>
      ...
      >
        ...
        <span className="flex  md:space-x-20  sm:mx-auto sm:mt-0 mt-2 justify-evenly md:justify-center sm:justify-start">
          ...
          <a target="_blank"><AiFillGithub className='text-cyan-600 text-xl md:text-4xl cursor-pointer'/></a>
          </Link>
          <Link href={'https://discord.com/users/898776433638400041'} className="text-gray-500">
      <a target='_blank'><SiDiscord className='text-cyan-600 text-xl md:text-4xl cursor-pointer'/></a>
          </Link>
          <Link href={'https://www.facebook.com/profile.php?id=100014142857134  '} className="text-cyan-500 ">
            <a target="_blank"><svg  fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="md:w-8 w-5 cursor-pointer " viewBox="0 0 24 24">
          ...
          <Link href={'https://www.instagram.com/harshdew.12/'} className="ml-3 text-cyan-500 ">
           <a target="_blank">
           <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="md:w-8 w-5 cursor-pointer " viewBox="0 0 24 24">
          ...
          <Link href={'https://www.linkedin.com/in/harsh-dewangan-3a44b5232/'} className="ml-3 text-cyan-500 ">
           <a target="_blank"> <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0" className="md:w-8 w-5 cursor-pointer " viewBox="0 0 24 24">
