...
export default function Home() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:py-4 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-2/3 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mx-32">
      ...
      <p className="mb-8 leading-relaxed">Pursuing B.Tech from Bhilai Institute Of Technology ,Durg .</p>
