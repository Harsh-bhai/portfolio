...
export default function Home() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:py-4 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-2/3 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mx-32 md:-translate-y-10">
      ...
      <p className="mb-8 text-cyan-500 leading-relaxed">Pursuing B.Tech from Bhilai Institute Of Technology ,Durg .<br/>Know more about me -<Link href={'/about'}><a className='text-white  font-bold'> Here</a></Link> </p>
      ...
      <div className="flex justify-center space-x-8 md:space-x-20 my-10 ">
      <Link  href={'https://github.com/Harsh-bhai'} className="text-gray-500">
      <a target="_blank"><AiFillGithub className='text-cyan-600 md:-my-1 md:text-3xl text-2xl  cursor-pointer'/></a>
          </Link>
          <Link  href={'https://www.linkedin.com/in/harsh-dewangan-3a44b5232/'} className="ml-3 text-gray-500">
            <a target="_blank"><FaLinkedinIn className='text-cyan-600 text-2xl cursor-pointer'/></a>
          </Link>
          <Link href={'https://discord.com/users/898776433638400041'} className="text-gray-500">
      <a target='_blank'><SiDiscord className='text-cyan-600 text-2xl cursor-pointer'/></a>
          </Link>
      
        <Link  href={'https://www.instagram.com/harshdew.12/'} className="ml-3 text-gray-500">
            <a target="_blank"><BsInstagram className='text-cyan-600 text-2xl cursor-pointer'/></a>
          </Link>
          <Link  href={'https://www.facebook.com/profile.php?id=100014142857134  '} className="text-gray-500">
      <a target="_blank"><ImFacebook className='text-cyan-600 text-2xl cursor-pointer'/></a>
          </Link>
      </div>
    </div>
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded animate-fadein5sec -translate-y-20 hidden md:block md:h-[50rem] brightness-75 hover:brightness-100 transition-transform" alt="hero" src='white2-min.png'/>
