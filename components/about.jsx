...
const About = () => {
  ...
  const info = [
    ...
    "As a Web and Android developer, I bring a unique blend of creativity and technical expertise to my projects. Also I have a great knowledge of Data Structures and Algorithms(DSA).",
